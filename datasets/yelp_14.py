...
class YELP14(Dataset):
    ...
    def __init__(self, path, fields, **kwargs):
        ...
        super(YELP14, self).__init__(examples, fields, **kwargs)

    @classmethod
    def splits(cls,
               path,
               train='yelp-2014-seg-20-20.train.ss',
               validation='yelp-2014-seg-20-20.dev.ss',
               test='yelp-2014-seg-20-20.test.ss',
               **kwargs):
        return super(YELP14, cls).splits(
    ...
    def iters(cls, path, batch_size=64, shuffle=True, device=0, vectors_path=None):
        ...
        if isinstance(cls.TEXT_FIELD, NestedField):
            cls.TEXT_FIELD.nesting_field.vocab = Vectors(name='yelp_14_text', cache=vectors_path)
        else:
            cls.TEXT_FIELD.vocab = Vectors(name='yelp_14_text', cache=vectors_path)
        cls.USR_FIELD.vocab = Vectors(name='yelp_14_usr', cache=vectors_path)
        cls.PRD_FIELD.vocab = Vectors(name='yelp_14_prd', cache=vectors_path)
